...
cursor.execute("CREATE TABLE IF NOT EXISTS CUSTOMER(CUSTOMER_ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,CUSTOMER_NAME VARCHAR(200) NOT NULL,PHONE_NUMBER CHAR(100),EMAIL VARCHAR(300),DATE_OF_BIRTH DATE,USER_PASSWORD VARCHAR(64) NOT NULL) engine = innodb default charset = latin1")


#CREATE THE ACCOUNT TABLE
cursor.execute("CREATE TABLE IF NOT EXISTS ACCOUNT(ACCOUNT_ID VARCHAR(20) NOT NULL PRIMARY KEY,ACCOUNT_NAME VARCHAR(30) NOT NULL,DATE_OF_JOINING DATE,ACCOUNT_TYPE CHAR(3),CUSTOMER_ID INT NOT NULL, FOREIGN KEY(CUSTOMER_ID) REFERENCES CUSTOMER(CUSTOMER_ID) ON DELETE NO ACTION) engine = innodb default charset = latin1")
